class Value < ApplicationRecord
  ...
  def self.calc_average_value(image_id)
    ...
    values_sum = values_arr.inject(:+) #Складывает все значения в массиве values_arr
    ave_value = values_sum/values_arr.size # Среднее значение равно общая сумма оценок делить на количество оценок в массиве
    ...
    ave_value.round # Округляем значение
  end
